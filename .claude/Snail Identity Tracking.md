...
- Shell tags are **fixed 3-digit codes per snail**; only on-screen viewing angle changes as the snail moves, the disc doesn't rotate on the shell
...
│   ├── tag_reader.py            # tag crop -> closed-set 3-digit code classifier
